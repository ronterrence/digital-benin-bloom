...
function restitutionImageUrl(file?: string) {
  if (!file) return null;
  return `${import.meta.env.BASE_URL}benin_output/restitution/${file}`;
}
      ...
      <div className="mx-auto max-w-6xl px-6 pt-24 pb-12">
        ...
        <div className="mt-10 space-y-6">
          {restitutionRecords.map((record) => {
            const imageUrl = restitutionImageUrl(record.imageFile);
              ...
              >
                ...
                <div className="mt-6 grid items-start gap-5 lg:grid-cols-[0.9fr_1.1fr]">
                  <div className="space-y-5">
                    {imageUrl && (
                      <div className="overflow-hidden rounded-lg border border-border/30 bg-background/40 p-4">
                        <img
                          src={imageUrl}
                          alt={record.title}
                          loading="lazy"
